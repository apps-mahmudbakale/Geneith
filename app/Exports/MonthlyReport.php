...
class MonthlyReport implements FromCollection, WithHeadings
{
    ...
    */
    public function collection()
    {
        ...
        ->selectRaw('DISTINCT products.name as product, requests.approved_qty, products.buying_price, products.selling_price, ABS((requests.approved_qty) - (station_products.quantity)) as sold, station_products.quantity as quantity, products.buying_price, products.selling_price, requests.approved_qty * products.buying_price, requests.approved_qty * products.selling_price, (requests.approved_qty * products.selling_price) - (requests.approved_qty * products.buying_price)')
